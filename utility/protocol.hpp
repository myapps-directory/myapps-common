// myapps/common/utility/protocol.hpp
...
inline constexpr auto metadata_factory = [](const auto& _rt, auto& _rctx, const solid::reflection::v1::TypeMapBase* _ptype_map) -> auto {
    ...
    } else if constexpr (solid::is_shared_ptr_v<value_t> || solid::is_unique_ptr_v<value_t> || solid::is_intrusive_ptr_v<value_t> || solid::is_mutable_intrusive_ptr_v<value_t> || solid::is_const_intrusive_ptr_v<value_t>) {
